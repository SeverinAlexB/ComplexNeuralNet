...
import Network.Learning.Propagation.WeightPropagation;
 ...
 */
public class WeightPropagationTest extends WeightPropagation {
    ...
    public void calcDeltaTest() {
        ...
        LayerResult layerResult = new LayerResult(neti);
    ...
    public void calcWeightDeltaTest()  {
       /* double eta = 1;
        ...
        //FieldMatrix<Complex> weightDiff = delta.outerProduct((FieldVector<Complex>) eta);
